...
  <section className="relative z-10" style={{ backgroundColor: g.bg }}>
    {/* for the increasing the distance between each servies section */}
    <div className="mx-auto max-w-5xl w-[92%] py-14 md:py-2">
      <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} variants={container}>
        <motion.h3 variants={item} className="text-center text-2xl font-bricolage md:text-3xl font-semibold text-black">
          {g.heading}
        </motion.h3>
